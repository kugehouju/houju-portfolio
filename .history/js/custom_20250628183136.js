...
$(function () {
        ...
        setTimeout(function () {
          tl2.to(cover, 0.4, {
            ...
            onComplete() {
              ...
              tl2.to(cover, 0.4, { marginLeft: "102%", ease: Expo.easeInOut });
            },
          });
        }, heroNum * 0);
  ...
  var OnePageNavigation = function () {
    ...
    $("body").on(
      "click",
      ".site-nav-wrap li a[href^='#'], .smoothscroll[href^='#'], .site-mobile-menu .site-nav-wrap li a[href^='#'], .site-footer a[href^='#'], .gsap-reveal-hero a[href^='#']",
      function (e) {
        e.preventDefault();
        var hash = this.hash;
      ...
      success: function (html) {
        ...
        pSingleHolder.append(
          '<div id="portfolio-single-' +
            id +
            '" class="portfolio-single-inner"><span class="unslate_co--close-portfolio js-close-portfolio d-flex align-items-center"><span class="icon-close2 wrap-icon-close"></span></span>' +
            getHTMLContent +
            "</div>"
        );
